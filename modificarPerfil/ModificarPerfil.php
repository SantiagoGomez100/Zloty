...
<?php  
    ...
    require ("modifi.php");
    session_start(); //reinico la sesion
    
    $id = $_SESSION['idUsuario'];
    
    $lista = new Usuario(); // llamada al metodo constructor
  ...
  <nav id="menu" class="navbar navbar-expand-lg  bg-pink">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="./imagenes/bigblanco.png" alt="" width="150px">
      </a>
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="botoncierre">
          <a href="../inicioLogueado/cerrar-sesion.php" class="cierresesion">Cerrar Sesion</a>
        </div>
      </div>
        ...
        <form action="modificar.php" method="POST">
          ...
          <div class="form-row contenedorCompleto">
            ...
            <div class="form-group col-md-10" style="margin-top: 10%;">
              ...
              <input type="text" class="form-control" name="nombre" id="inputAddress" placeholder="Ingrese Nombre" value="<?php echo $matrizusuario[0]['nombre'];?>" autofocus required
              ><i
                class="fas fa-edit"></i>
            </div>
            <div class="form-group col-md-10";>
              <label for="inputAddress" style="color: white;">Apellido</label>
              <input type="text" class="form-control" name="apellido" id="inputAddress" placeholder="Ingrese Apellido" value="<?php echo $matrizusuario[0]['apellido']; ?>" autofocus required
              ><i
                class="fas fa-edit"></i>
            </div>
            ...
            <div class="form-group col-md-10">
              ...
              <input type="text" class="form-control" name="telefono"  value="<?php echo $matrizusuario[0]['telefono']; ?>"  placeholder="30000000" required><i
                class="fas fa-edit"></i>
            </div>
            ...
            <div class="form-group col-md-10">
                ...
                <select id="inputState" type="text" name="ciudad" value="<?php echo $matrizusuario[0]['ciudad']; ?>" class="form-control controls">
          ...
          <div class="container botones">
            <div class="row">
              <div class="col-sm">
                <button type="submit" class="btn colorBoton "> <a>Confirmar Cambios</a> </button> </div>
              <div class="col-sm">
                <button type="submit" class="btn colorBoton  "> <a href="../inicioLogueado/logueado.php"
