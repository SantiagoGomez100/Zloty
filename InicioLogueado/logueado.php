...
<body style="background-color:#27292D;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="text-align: center;">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item correrUsers">
                            ...
                            <a class="nav-link letracolor " href="../subirUnProducto/subirProducto.html" style="color: #ffffff;">
                                Añadir Producto</a>
                        </li>
    ...
    <div class= "container">
            <article class="cuadro">
                <img src="imagenes/mensajero.png" class="imagencuadro" alt="Equipo Zloty">
    ...
    <!-- Seccion de Donaciones e Intercambio -->
        ...
        <center><img src="imagenes/titulo2.png" alt="Equipo Zloty"></center>
    </div>
            ...
            <div class="contenedor">
                <div class="galeria-port">
                    <div class="imagen-port">
                        <img src="./imagenes/cicla.jpg" alt="">
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/patines.jpg" alt="">
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/escritorio.jpg" alt="">
                        <div class="hover-galeria">
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/perrohouse.jpg" alt="">
                        <div class="hover-galeria">
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/puerta.jpg" alt="">
                        <div class="hover-galeria">
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/cajon.jpg" alt="">
                        <div class="hover-galeria">
                            <p>Closet</p>
                        </div>
                    </div>
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/pantalla windos.jpg" alt="">
                        <div class="hover-galeria">
                            <p>Pantalla LG</p>
                        </div>
                    </div>
                    ...
                    <div class="imagen-port">
                        <img src="./imagenes/Classical_Guitar_two_views.jpg" alt="">
                        <div class="hover-galeria">
                            <p>Guitarra</p>
                        </div>
                    </div>
