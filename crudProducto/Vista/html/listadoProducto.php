...
<body style="background-color:#27292D;">
  ...
  <div class="carousel-inner">      
    ...
    <div >        
    <center>
        <h1 style =" color: red; ">LISTADO DE PRODUCTOS</h1><br>
        <a href="Cnuevoproducto.php" style =" color: red; ">NUEVO PRODUCTO</a>
    </center>
    
    <table class="table" width="1016" border="1" style =" color: white; ">
            <tr>
            ...
            <tr>
              ...
              foreach ($matrizproducto as $fila) {
                ?>
                    ...
                    <td><a href="../Controlador/Cmodificarproducto.php?doc_prof=<?php echo $fila['idProducto']; ?>">Modificar</a></td>
                    <td><a href="../Controlador/Cmodificarproducto.php?doc_prof=<?php echo $fila['idProducto']; ?>">Donar</a></td>
                    <td><a href="../Controlador/Cmodificarproducto.php?doc_prof=<?php echo $fila['idProducto']; ?>">Intercambiar</a></td>
