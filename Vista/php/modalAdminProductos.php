             ...
             <div class="modal-body p-4" >
                 ...
                 <form
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="exampleInputPassword1" name="descripcion" value="<?php echo $matrizProducto1[0]['descripcionProducto'];?>" required>
                     </div>
                     <div class="mb-3">
                         <label for="exampleInputText" class="form-label tables2">Existencias </label>
                         <input type="number" class="form-control" id="exampleInputPassword1" name="existencias" value="<?php echo $matrizProducto1[0]['Existencias'];?>" required>
                     </div>
                     <div class="mb-3">
