    ...
    <div class ="col">
        ...
        <div class="col-7">            
             <div class="justify-content-xs-center" id="tablaProducto">
                 ...
                 <form action="Cactualizarproducto2.php?idProducto=<?php echo $matrizProducto[0]['idProducto'];?>" method="post">
                <center>
                  <table class="table " style =" color: white;">
                    ...
                    <tr>
                      ...
                      <tr>
                      <td>&nbsp;</td>
                      <td><input name="intercambiar" type="submit" id="intercambiar" value="intercambiar" /></td>
                    </tr>
                  </table>
                </center>
              </form>
