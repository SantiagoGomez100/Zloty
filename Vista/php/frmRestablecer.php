                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  p-5 ">
                        ...
                        <section>
                            ...
                            <h4 class="dinosEmail">Ingresa el código enviado a tu correo para continuar.</h4>
                        </section>
                        <!-- formulario  -->
                        <form action="../../Controlador/CverificarCod.php" method="post">

                            <!-- email -->
                            <div class="form-group  ml-5">
                                <label for="number" class="colorLabel">Codigo</label>
                                <input type="number" class="form-control inputPeque" name="codigo" id="codigo"
                                    placeholder="00000" required>
                                <input type="hidden" class="form-control inputPeque" name="correo" id="correo" value="<?php echo $email?>"
                                    >
                                <input type="hidden" class="form-control inputPeque" name="token" id="token" value="<?php echo $token?>"
                                    >
                            </div>                            
                                <div class="form-row">
