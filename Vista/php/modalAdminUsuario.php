             ...
             <div class="modal-body p-4" >
                 ...
                 <form
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="exampleInputPassword1" name="apellido" value="<?php echo $matrizUsuario1[0]['apellido'];?>" required>
                     </div>
                     <div class="mb-3">
                         <label for="exampleInputText" class="form-label tables2">Email </label>
                         <input type="email" class="form-control" id="exampleInputPassword1" name="email" value="<?php echo $matrizUsuario1[0]['email'];?>" required>
                     </div>
                     <div class="mb-3">
                         <label for="exampleInputText" class="form-label tables2">Telefono </label>
                         <input type="number" class="form-control" id="exampleInputPassword1" name="telefono" value="<?php echo $matrizUsuario1[0]['telefono'];?>" required>
                     </div>
                     <div class="mb-3">
